...
assets['imagem_instrucoes'] = pygame.image.load('Imagens/instruções.png').convert()
assets['imagem_instrucoes'] = pygame.transform.scale(assets['imagem_instrucoes'] , (650,800))
