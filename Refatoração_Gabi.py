...
def carregaTodosOsAssets():
    assets = {}
    carregaImagens(assets)
    carregaAnimacoes(assets)
    carregaFontes(assets)
    carregaSons(assets)
    return assets

#definindo a variavel e chamando a função
assets = carregaTodosOsAssets()
